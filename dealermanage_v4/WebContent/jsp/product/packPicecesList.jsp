...
{
	var id = document.getElementsByName('pack_piceces_id');
	var idValue;
	...
	//for update [S]
	var updatePathWithIdValue = "${pageContext.request.contextPath}/PackPicecesController?action=edit&pack_piceces_id="+idValue;
	//for update [E]
	//for delete [S]
	var deletePathWithIdValue = "${pageContext.request.contextPath}/PackPicecesController?action=delete&pack_piceces_id="+idValue;
	//for delete [E]
	//for enquiry [S]
	var enquiryPathWithIdValue = "${pageContext.request.contextPath}/PackPicecesController?action=enquiry&pack_piceces_id="+idValue;
	//for enquiry [E]
...
<div class="mcontent">
			<div class="titlenav">
			<ul>
					<li class="title"><a href="${pageContext.request.contextPath}/jsp/product/packPiceces.jsp">Pack Pieces List</a></li>
					<li class="bread"><a href="">Dashboard > Product 
							Management > Pack Pieces List</a></li>
				</ul>
			</div>
			<br>
<div class="card">
	<table id="example" class="display" style="width: 100%; font-size: 13px;">
		...
		<tbody>
			<c:forEach items="${packPieces}" var="pp"> 
				<tr>
					<td Class ="FormInputColor"><input type="radio" name="pack_piceces_id" id="pack_piceces_id" value="${pp.pack_piceces_id}" onclick="javascript: getRadioValue();" /></td>
					<td Class ="FormInputColor"><c:out value="${pp.pack_piceces_id}" /></td>
...
<input type="hidden" name="val" id="val" value="" />
	<table align="center" width="100%">
				...
				<tr>
					...
					<br>
					<a Class ="button" href="${pageContext.request.contextPath}/PackPicecesController?action=save">add</a>
